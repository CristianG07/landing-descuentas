...
<body>
  <header class="header">
    <nav class="container nav">
      ...
      <a class="btn_nav" href="./pages/registro.php">INSTALAR GRATIS</a>
    </nav>
  </header>
  ...
  <main class="main">
    <section class="hero">
      <div class="container hero_section nav">
        ...
        <div class="hero_info">
          ...
          <a class="btn_primry" href="./pages/registro.php">INSTALAR GRATIS</a>
        </div>
      </div>
    </section>
    ...
    <section class="section5">
      ...
      <div class="content_btn">
        <a class="btn_primry btn--modify" href="./pages/registro.php">INSTALAR GRATIS</a>
      </div>
    </section>
  </main>
